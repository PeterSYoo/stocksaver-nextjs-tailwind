  ...
  return (
    <>
      <div className="flex flex-col gap-2">
        <div className="bg-[#F1F6FA] flex flex-col justify-between rounded-3xl shadow-md shadow-gray-500 px-3 py-4 h-36">
        ...
        <div className="flex justify-end mr-1">
          <button className="text-2xl text-red-600 hover:text-black">
            <TiDelete />
          </button>
        </div>
      </div>
